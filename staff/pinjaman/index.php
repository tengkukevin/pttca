...
$sql = "SELECT * FROM tb_pengajuan_pinjaman WHERE id_karyawan = '$id_karyawan' ORDER BY id DESC";
...
<section class="content">
    <div class="row" style="margin-bottom:10px">
        <div class="col-md-12">
            <a class="btn btn-success" href="<?= $base_url ?>staff/pinjaman/create.php"><i class="fa fa-plus"></i> Pengajuan Pinjaman</a>
        </div>
    </div>
    <div class="row">
        <div class="col-md-12">
