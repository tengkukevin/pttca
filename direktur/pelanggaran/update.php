...
if(isset($_GET['id'])) {
    $id = $_GET['id'];
    $info_pelanggaran = find("tb_pelanggaran", array("id" => $id))[0];
}
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="nama" class="form-control">
                                        <?php foreach ($list_karyawan as $karyawan): ?>
                                            <option value="<?=$karyawan["nik"]?>" <?=$karyawan['nik'] == $info_pelanggaran["id_karyawan"] ? "selected" : ""?>><?=$karyawan["nama_lengkap"]?></option>
                                        <?php endforeach ?>
                                    </select>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="tingkat" class="form-control">
                                        <option value="SP1" <?=$info_pelanggaran["tingkat"] == "SP1" ? "selected" : ""?>>SP1</option>
                                        <option value="SP2" <?=$info_pelanggaran["tingkat"] == "SP2" ? "selected" : ""?>>SP2</option>
                                        <option value="SP3" <?=$info_pelanggaran["tingkat"] == "SP3" ? "selected" : ""?>>SP3</option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="tarif">Tingkat Pelanggaran</label>
                                    <input type="date" name="tanggal" class="form-control" value="<?=$info_pelanggaran["tanggal"]?>">
                                </div>
                            </div>
                        </div>
                    </div>
