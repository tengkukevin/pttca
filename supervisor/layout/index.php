          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-footer">
                <div class="pull-left">
                  <a href="<?=$base_url?>supervisor/profile.php" class="btn btn-default btn-flat">Profile</a>
                </div>
                <div class="pull-right">
                  <a href="<?=$base_url?>supervisor/logout.php" class="btn btn-default btn-flat">Sign out</a>
                </div>
              </li>
            </ul>
          </li>
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li class=""><a href="<?= $base_url ?>supervisor/borongan/index.php"><i class="fa fa-circle-o"></i> Lihat Borongan</a></li>
            <li><a href="<?= $base_url ?>supervisor/borongan/create.php"><i class="fa fa-circle-o"></i> Tambah Borongan</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
