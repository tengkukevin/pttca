                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <?php if ($k['status'] == 'Diterima Supervisor'): ?>
                                                    <a href="<?= $base_url ?>areamanager/permohonanpinjamanborongan/terima.php?id=<?= $k['id'] ?>" class="btn btn-success btn-sm">
                                                        <i class="fa fa-check"></i> Terima
                                                    </a>
                                                    <a onclick="return confirm('Apakah anda yakin?')" href="<?= $base_url ?>areamanager/permohonanpinjamanborongan/tolak.php?id=<?= $k['id'] ?>" class="btn btn-danger btn-sm">
